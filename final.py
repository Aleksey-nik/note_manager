listing=[input("Введите имя пользователя"),input("Введите описание заметки"),
         input("Введите статус заметки"),input("Введите дату создания,дд.мм.гг"),
         input("Введите дату истечения,дд.мм.гг"),[input("Введите заголовок заметки1"),
         input("Введите заголовок заметки2"),input("Введите заголовок заметки3")]]
